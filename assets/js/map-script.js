...
function init() {
    var myMapTemp = new ymaps.Map("map-yandex", {
        center: [53.928180, 27.549857], // координаты центра на карте
        zoom: 13,
    ...
    var myPlacemarkTemp = new ymaps.Placemark([53.928180, 27.549857], {
        balloonContent: "ул. Каховская 28А, офис 12",
    }, {
        // Опции.
